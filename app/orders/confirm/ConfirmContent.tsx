  ...
  return (
    <main className="min-h-screen bg-bloom-cream flex items-center justify-center px-6">
      <div className="max-w-md w-full text-center space-y-6">
        {status === 'loading' && (
          <>
            <div className="w-12 h-12 border-2 border-bloom-rose border-t-bloom-berry rounded-full animate-spin mx-auto" />
            <p className="font-body text-bloom-bark/60 tracking-wide">Confirming your payment…</p>
          </>
        )}
        {status === 'success' && (
          <>
            ...
            <p className="font-body text-sm text-bloom-bark/60 leading-relaxed">
              Thank you for shopping with BloomShelf. Your order is being prepared for shipment.
            </p>
